...
Module MedicineModule
    ...
    Private Function IsMedicineDosageUnique(medicineName As String, dosage As String) As Boolean
        Try
    ...
    Private Function AddCategory(categoryName As String) As Boolean
        Try
    ...
    Private Function SearchCategoryByName(categoryName As String) As DataTable
        Try
    ...
    Private Function UpdateCategory(oldCategoryName As String, newCategoryName As String) As Boolean
        Try
    ...
    Private Function DeleteCategory(categoryName As String) As Boolean
        Try
    ...
    Private Function IsCategoryUnique(categoryName As String) As Boolean
        Try
    ...
    Private Function SearchMedicine(keyword As String, minStockQuantity As Integer, category As String) As DataTable
        Try
