...
Imports System.IO
Public Class UploadRecordMH
    Private Sub UploadRecordMH_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DisplayDoctorRequestsInGrid()
    End Sub

    Private Sub DisplayDoctorRequestsInGrid()
        Try
            Dim receiverDoctorID As String = DocumentsPanelMH.DoctorIDLBL.Text
