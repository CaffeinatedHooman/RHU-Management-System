...
Imports System.Data
Public Class DownloadFilesMH
    Private Sub DownloadFilesMH_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DisplayDoctorRequestFiles()
    End Sub

    Private Sub DisplayDoctorRequestFiles()
        Try
            Dim doctorID As String = DocumentsPanel.DoctorIDLBL.Text
