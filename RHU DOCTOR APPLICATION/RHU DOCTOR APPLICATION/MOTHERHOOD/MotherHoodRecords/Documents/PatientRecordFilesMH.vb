...
Public Class PatientRecordFilesMH
    Private Sub PatientRecordFilesMH_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadDoctorsIntoComboBox()
        Try
            ...
            If doctorsDataTable.Rows.Count > 0 Then
                Dim currentDoctorName As String = DocumentsPanelMH.DoctorNameLBL.Text
    ...
    Private Sub btnSaveRequest_Click(sender As Object, e As EventArgs) Handles btnSaveRequest.Click
        Try
            Dim senderDoctorID As String = DocumentsPanelMH.DoctorIDLBL.Text
