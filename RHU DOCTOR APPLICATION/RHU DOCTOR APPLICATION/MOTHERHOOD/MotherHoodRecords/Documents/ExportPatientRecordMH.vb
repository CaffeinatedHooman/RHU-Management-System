...
Public Class ExportPatientRecordMH
    ...
    Private Function GetRecordPatient(patientID As String) As DataTable
        ...
        FROM
            treatment_motherhood AS T
        INNER JOIN
            Patients AS P ON T.PatientID = P.PatientID
        WHERE
    ...
    Private Sub ExportPatientRecordMH_Load(sender As Object, e As EventArgs) Handles MyBase.Load
