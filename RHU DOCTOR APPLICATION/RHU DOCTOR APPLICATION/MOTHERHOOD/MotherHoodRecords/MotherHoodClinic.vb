...
Public Class MotherHoodClinic
    ...
    Public Sub UpdateRequestCountLabel()
        ...
        End Try
    End Sub
    Private Sub MotherHoodClinic_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MotherHoodClinic_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        MotherHoodLogoutPage()
        Application.Exit()
    End Sub
    ...
    Private Sub OncallDoctorVTN_Click(sender As Object, e As EventArgs) Handles OncallDoctorVTN.Click
        MotherHoodOncall.ShowDialog()
    End Sub

    Private Sub PatientrecordVTN_Click(sender As Object, e As EventArgs) Handles PatientrecordVTN.Click
        MotherHoodRecords.ShowDialog()
    End Sub

    Private Sub PatientListVTN_Click(sender As Object, e As EventArgs) Handles PatientListVTN.Click
        MotherHoodList.ShowDialog()
    End Sub

    Private Sub RECORDARC_Click(sender As Object, e As EventArgs) Handles RECORDARC.Click
        DocumentsPanelMH.ShowDialog()
    End Sub
End Class