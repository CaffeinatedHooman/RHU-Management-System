...
Public Class ExportPatientRecord
    ...
    Private Function GetRecordPatient(patientID As String) As DataTable
        Try
            Dim sql As String = "
        SELECT CONCAT(P.FirstName, ' ', P.LastName) AS FullName, VS.*, I.IllnessName
        FROM treatment AS VS
        INNER JOIN Patients AS P ON VS.PatientID = P.PatientID
        LEFT JOIN illnesses AS I ON VS.PatientIllnessID = I.IllnessID
    ...
    Private Sub ExportPatientRecord_Load(sender As Object, e As EventArgs) Handles MyBase.Load
