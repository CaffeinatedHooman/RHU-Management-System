...
Imports System.IO
Public Class UploadRecordHAS
    Private Sub UploadRecordHAS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub DisplayDoctorRequestsInGrid()
        Try
            Dim receiverDoctorID As String = HAS_CLINIC.DoctorIDLBL.Text
