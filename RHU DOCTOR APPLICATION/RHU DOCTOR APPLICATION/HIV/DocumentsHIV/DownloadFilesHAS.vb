...
Imports System.Data
Public Class DownloadFilesHAS
    Private Sub DownloadFilesHAS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DisplayDoctorRequestFiles()
    End Sub
    Private Sub DisplayDoctorRequestFiles()
        Try
            Dim doctorID As String = DocumentsPanelHIV.DoctorIDLBL.Text
