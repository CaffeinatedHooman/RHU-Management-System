...
Public Class ExportPatientRecordHAS
    Private Sub ExportPatientRecordHAS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            Dim sql As String = "
                            SELECT CONCAT(P.FirstName, ' ', P.LastName) AS FullName,
                                   ...
                                   TRH.HIV_AIDS_Status,
                                   TRH.STI_Status,
                                   TRH.HIV_AIDS_Medication,
                                   TRH.STI_Medication,
                                   TRH.HealthStatus,
                                   TRH.DateRecorded
                            FROM treatmentrecordhas AS TRH
                            INNER JOIN Patients AS P ON TRH.PatientID = P.PatientID
                            WHERE TRH.PatientID = @PatientID
                         "
