...
Module ClinicSetup1M
    Public Function Clinic1LoginPage() As Boolean
        Try
            Dim Username As String = Clinic1Login.UsernameLogin.Text.Trim
            Dim AccessCode As String = Clinic1Login.AcesscodeLogin.Text.Trim
            ...
            If Not String.Equals(AccessCode, My.Settings.SelectedAccessCodeClinic1) Then
