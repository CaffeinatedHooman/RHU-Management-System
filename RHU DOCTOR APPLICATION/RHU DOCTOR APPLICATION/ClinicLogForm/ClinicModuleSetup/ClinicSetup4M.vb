Module ClinicSetup4M
    Public Function Clinic4LoginPage() As Boolean
        Try
            Dim Username As String = Clinic4Login.UsernameLogin.Text.Trim
            Dim AccessCode As String = Clinic4Login.AcesscodeLogin.Text.Trim
            ...
            If Not String.Equals(AccessCode, My.Settings.SelectedAccessCodeClinic4) Then
