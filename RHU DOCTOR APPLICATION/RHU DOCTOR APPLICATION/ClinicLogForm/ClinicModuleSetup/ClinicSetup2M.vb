Module ClinicSetup2M
    Public Function Clinic2LoginPage() As Boolean
        Try
            Dim Username As String = Clinic2Login.UsernameLogin.Text.Trim
            Dim AccessCode As String = Clinic2Login.AcesscodeLogin.Text.Trim
            ...
            If Not String.Equals(AccessCode, My.Settings.SelectedAccessCodeClinic2) Then
