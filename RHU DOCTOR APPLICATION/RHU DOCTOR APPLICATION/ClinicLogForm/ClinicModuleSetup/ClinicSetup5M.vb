Module ClinicSetup5M
    Public Function Clinic5LoginPage() As Boolean
        Try
            Dim Username As String = Clinic5Login.UsernameLogin.Text.Trim
            Dim AccessCode As String = Clinic5Login.AcesscodeLogin.Text.Trim
            ...
            If Not String.Equals(AccessCode, My.Settings.SelectedAccessCodeClinic5) Then
