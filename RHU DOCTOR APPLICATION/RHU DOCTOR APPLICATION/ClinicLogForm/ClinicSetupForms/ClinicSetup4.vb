Public Class ClinicSetup4
    Private Sub ClinicSetup4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadClinicNames()

        Dim LocalClinicName As String = My.Settings.ClinicButtonName4
        ...
        Dim savedAccessCode As String = My.Settings.SelectedAccessCodeClinic4

        If String.IsNullOrEmpty(savedAccessCode) Then
            savedAccessCode = "DefaultAccessCode"
        End If

        LbLSelectedAccessCodeClinic4.Text = savedAccessCode
    End Sub
    ...
    Private Sub cmbClinics_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbClinics.SelectedIndexChanged
        Try
            If cmbClinics.SelectedIndex <> -1 Then
                ...
                LbLSelectedAccessCodeClinic4.Text = accessCode
            End If
        Catch ex As Exception
    ...
    Private Sub btnSaveAccessCode_Click(sender As Object, e As EventArgs) Handles btnSaveAccessCode.Click
        Try
            If cmbClinics.SelectedIndex <> -1 Then
                ...
                My.Settings.SelectedAccessCodeClinic4 = accessCode
                My.Settings.ClinicButtonName4 = cmbClinics.SelectedItem
                DoctorsPanel.ClinicVTN6.Text = My.Settings.ClinicButtonName4
                My.Settings.Save()

                LbLSelectedAccessCodeClinic4.Text = accessCode
                Label1.Text = My.Settings.ClinicButtonName4
