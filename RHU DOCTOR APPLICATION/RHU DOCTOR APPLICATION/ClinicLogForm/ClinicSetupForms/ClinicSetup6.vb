Public Class ClinicSetup6
    Private Sub ClinicSetup6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadClinicNames()

        Dim LocalClinicName As String = My.Settings.ClinicButtonName6
        ...
        Dim savedAccessCode As String = My.Settings.SelectedAccessCodeClinic6

        If String.IsNullOrEmpty(savedAccessCode) Then
            savedAccessCode = "DefaultAccessCode"
        End If

        LbLSelectedAccessCodeClinic6.Text = savedAccessCode
    End Sub
    ...
    Private Sub cmbClinics_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbClinics.SelectedIndexChanged
        Try
            If cmbClinics.SelectedIndex <> -1 Then
                ...
                LbLSelectedAccessCodeClinic6.Text = accessCode
            End If
        Catch ex As Exception
    ...
    Private Sub btnSaveAccessCode_Click(sender As Object, e As EventArgs) Handles btnSaveAccessCode.Click
        Try
            If cmbClinics.SelectedIndex <> -1 Then
                ...
                My.Settings.SelectedAccessCodeClinic6 = accessCode
                My.Settings.ClinicButtonName6 = cmbClinics.SelectedItem
                DoctorsPanel.GeneralClinic.Text = My.Settings.ClinicButtonName6
                My.Settings.Save()

                LbLSelectedAccessCodeClinic6.Text = accessCode
                Label1.Text = My.Settings.ClinicButtonName6
