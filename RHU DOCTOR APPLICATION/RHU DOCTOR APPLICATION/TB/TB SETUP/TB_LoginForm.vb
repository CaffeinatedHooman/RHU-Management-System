Public Class TB_LoginForm
    Private Sub TB_LoginForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
    End Sub
    ...
    Private Sub TB_LoginForm_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.Control AndAlso e.KeyCode = Keys.F11 Then

            Dim newForm As New TB_SETUP()
            newForm.Show()
        End If
    End Sub
