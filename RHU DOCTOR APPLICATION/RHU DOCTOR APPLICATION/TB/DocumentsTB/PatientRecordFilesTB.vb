...
Public Class PatientRecordFilesTB
    Private Sub PatientRecordFilesTB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadDoctorsIntoComboBox()
        Try
            ...
            If doctorsDataTable.Rows.Count > 0 Then
                Dim currentDoctorName As String = DocumentsPanelTB.DoctorNameLBL.Text
